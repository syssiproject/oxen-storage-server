...
#include <sispopss/common/formattable.h>

namespace sispop::crypto {

using namespace std::literals;

constexpr std::string_view SUBKEY_HASH_KEY = "SispopSSSubkey"sv;
...
template <>
inline constexpr bool sispop::to_string_formattable<sispop::crypto::legacy_pubkey> = true;
template <>
inline constexpr bool sispop::to_string_formattable<sispop::crypto::ed25519_pubkey> = true;
template <>
inline constexpr bool sispop::to_string_formattable<sispop::crypto::x25519_pubkey> = true;

namespace std {

template <typename Derived, size_t N>
struct hash<sispop::crypto::pubkey_base<Derived, N>> {
    size_t operator()(const sispop::crypto::pubkey_base<Derived, N>& pk) const {
...
template <>
struct hash<sispop::crypto::legacy_pubkey> : hash<sispop::crypto::legacy_pubkey::PubKeyBase> {};
template <>
struct hash<sispop::crypto::x25519_pubkey> : hash<sispop::crypto::x25519_pubkey::PubKeyBase> {};
template <>
struct hash<sispop::crypto::ed25519_pubkey> : hash<sispop::crypto::ed25519_pubkey::PubKeyBase> {};
