...
import pytest
from sispopmq import SispopMQ, Address
import json
import random
...
@pytest.fixture(scope="module")
def sns(omq):
    remote = omq.connect_remote(Address("curve://public.sispop.site:38161/80adaead94db3b0402a6057869bdbe63204a28e93589fd95a035480ed6c03b45"))
